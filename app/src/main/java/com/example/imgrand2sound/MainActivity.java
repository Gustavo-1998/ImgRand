    ...
    public void mostrarRand() {
       // randoms();
        do {
            ...
            pickedImage = randArray[sr].getImagen();
            pickedText = randArray[sr].getAleatorio();
        ...
        imagen.setImageResource(pickedImage);
        letrero.setText(pickedText);
    }
